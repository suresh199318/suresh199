pipeline {
   ...
   sh "aws cloudformation deploy --template-file ec2fin.json --stack-name teststack2 --parameter-overrides InstanceType=t2.micro KeyName=ohio TagName=ec2nginx --region 'us-east-2'" 
